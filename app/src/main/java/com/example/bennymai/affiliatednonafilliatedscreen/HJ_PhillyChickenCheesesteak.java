...
public class HJ_PhillyChickenCheesesteak extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("HJ_PhillyChickenCheesesteak_Like");
        final DatabaseReference myRef2 = database.getReference("HJ_PhillyChickenCheesesteak_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_hj__philly_chicken_cheesesteak);
