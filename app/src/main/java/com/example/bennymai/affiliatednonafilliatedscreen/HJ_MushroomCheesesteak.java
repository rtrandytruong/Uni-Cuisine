...
public class HJ_MushroomCheesesteak extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hj__mushroom_cheesesteak);
        ...
        final DatabaseReference myRef = database.getReference("HJ_MushroomCheesesteak_Like");
        final DatabaseReference myRef2 = database.getReference("HJ_MushroomCheesesteak_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_hj__mushroom_cheesesteak);
