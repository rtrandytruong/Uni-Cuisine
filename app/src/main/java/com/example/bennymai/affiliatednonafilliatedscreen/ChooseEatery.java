...
public class ChooseEatery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) findViewById(R.id.urbanlist);
        ...
        */
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(getArguments().getInt(ARG_SECTION_NUMBER)==1) {
                ...
                View rootView = inflater.inflate(R.layout.fragment_urban, container, false);
                return rootView;
            } else if(getArguments().getInt(ARG_SECTION_NUMBER)==2) {

                View rootView = inflater.inflate(R.layout.fragment_northside, container, false);
                return rootView;
            } else if(getArguments().getInt(ARG_SECTION_NUMBER)==3) {

                View rootView = inflater.inflate(R.layout.fragment_hans, container, false);
                return rootView;
            }
            else {
