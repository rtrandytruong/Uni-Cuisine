...
public class Mai_ChickenRiceSoup extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mai__chicken_rice_soup);
        ...
        final DatabaseReference myRef = database.getReference("Mai_ChickenRiceSoup_Like");
        final DatabaseReference myRef2 = database.getReference("Mai_ChickenRiceSoup_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_mai__chicken_rice_soup);
