...
public class I_BaconTomatoGrilledCheese extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__bacon_tomato_grilled_cheese);
        ...
        final DatabaseReference myRef = database.getReference("I_BaconTomatoGrilledCheese_Like");
        final DatabaseReference myRef2 = database.getReference("I_BaconTomatoGrilledCheese_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__bacon_tomato_grilled_cheese);
