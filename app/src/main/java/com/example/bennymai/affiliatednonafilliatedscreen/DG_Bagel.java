...
public class DG_Bagel extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__bagel);
        ...
        final DatabaseReference myRef = database.getReference("DG_Bagel_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Bagel_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__bagel);
