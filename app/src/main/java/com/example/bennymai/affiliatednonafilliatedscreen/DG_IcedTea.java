...
public class DG_IcedTea extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__iced_tea);
        ...
        final DatabaseReference myRef = database.getReference("DG_IcedTea_Like");
        final DatabaseReference myRef2 = database.getReference("DG_IcedTea_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__iced_tea);
