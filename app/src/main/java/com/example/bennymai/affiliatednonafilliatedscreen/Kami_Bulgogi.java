...
public class Kami_Bulgogi extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kami__bulgogi);
        ...
        final DatabaseReference myRef = database.getReference("Kami_Bulgogi_Like");
        final DatabaseReference myRef2 = database.getReference("Kami_Bulgogi_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kami__bulgogi);
