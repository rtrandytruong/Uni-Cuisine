...
public class Halal_ChapliKebabRice extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("Halal_ChapliKebabRice_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_ChapliKebabRice_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__chapli_kebab_rice);
