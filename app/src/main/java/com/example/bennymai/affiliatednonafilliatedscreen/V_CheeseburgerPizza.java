...
public class V_CheeseburgerPizza extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v__cheeseburger_pizza);
        ...
        final DatabaseReference myRef = database.getReference("V_CheeseburgerPizza_Like");
        final DatabaseReference myRef2 = database.getReference("V_CheeseburgerPizza_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_v__cheeseburger_pizza);
