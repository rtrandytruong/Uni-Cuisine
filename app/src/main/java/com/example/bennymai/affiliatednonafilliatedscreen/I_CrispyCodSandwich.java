...
public class I_CrispyCodSandwich extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__crispy_cod_sandwich);
        ...
        final DatabaseReference myRef = database.getReference("I_CrispyCodSandwich_Like");
        final DatabaseReference myRef2 = database.getReference("I_CrispyCodSandwich_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__crispy_cod_sandwich);
