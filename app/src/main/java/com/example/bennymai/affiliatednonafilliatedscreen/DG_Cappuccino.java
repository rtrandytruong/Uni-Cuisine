...
public class DG_Cappuccino extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__cappuccino);
        ...
        final DatabaseReference myRef = database.getReference("DG_Cappuccino_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Cappuccino_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__cappuccino);
