...
public class Kami_SpicyChicken extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kami__spicy_chicken);
        ...
        final DatabaseReference myRef = database.getReference("Kami_SpicyChicken_Like");
        final DatabaseReference myRef2 = database.getReference("Kami_SpicyChicken_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kami__spicy_chicken);
