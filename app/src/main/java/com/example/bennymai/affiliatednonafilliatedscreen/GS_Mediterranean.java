...
public class GS_Mediterranean extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gs__mediterranean);
        ...
        final DatabaseReference myRef = database.getReference("GS_Mediterranean_Like");
        final DatabaseReference myRef2 = database.getReference("GS_Mediterranean_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_gs__mediterranean);
