...
public class I_TriBlendCheeseburger extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__tri_blend_cheeseburger);
        ...
        final DatabaseReference myRef = database.getReference("I_TriBlendCheeseburger_Like");
        final DatabaseReference myRef2 = database.getReference("I_TriBlendCheeseburger_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__tri_blend_cheeseburger);
