...
public class Kim_SesameChicken extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kim__sesame_chicken);
        ...
        final DatabaseReference myRef = database.getReference("Kim_SesameChicken_Like");
        final DatabaseReference myRef2 = database.getReference("Kim_SesameChicken_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kim__sesame_chicken);
