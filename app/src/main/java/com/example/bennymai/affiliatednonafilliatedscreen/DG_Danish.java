...
public class DG_Danish extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__danish);
        ...
        final DatabaseReference myRef = database.getReference("DG_Danish_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Danish_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__danish);
