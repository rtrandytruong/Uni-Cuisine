...
public class I_MozzarellaSticks extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__mozzarella_sticks);
        ...
        final DatabaseReference myRef = database.getReference("I_MozzarellaSticks_Like");
        final DatabaseReference myRef2 = database.getReference("I_MozzarellaSticks_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__mozzarella_sticks);
