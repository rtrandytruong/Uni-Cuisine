...
public class Halal_FishOverRice extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__fish_over_rice);
        ...
        final DatabaseReference myRef = database.getReference("Halal_FishOverRice_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_FishOverRice_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__fish_over_rice);
