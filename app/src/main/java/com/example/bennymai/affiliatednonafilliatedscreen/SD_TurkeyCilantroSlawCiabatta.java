...
public class SD_TurkeyCilantroSlawCiabatta extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd__turkey_cilantro_slaw_ciabatta);
        ...
        final DatabaseReference myRef = database.getReference("SD_TurkeyCilantroSlawCiabatta_Like");
        final DatabaseReference myRef2 = database.getReference("SD_TurkeyCilantroSlawCiabatta_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sd__turkey_cilantro_slaw_ciabatta);
