...
public class SD_CapresePanini extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd__caprese_panini);
        ...
        final DatabaseReference myRef = database.getReference("SD_CapresePanini_Like");
        final DatabaseReference myRef2 = database.getReference("SD_CapresePanini_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sd__caprese_panini);
