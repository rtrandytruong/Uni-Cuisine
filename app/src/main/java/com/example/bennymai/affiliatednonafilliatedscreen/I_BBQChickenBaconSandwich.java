...
public class I_BBQChickenBaconSandwich extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__bbqchicken_bacon_sandwich);
        ...
        final DatabaseReference myRef = database.getReference("I_BBQChickenBaconSandwich_Like");
        final DatabaseReference myRef2 = database.getReference("I_BBQChickenBaconSandwich_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__bbqchicken_bacon_sandwich);
