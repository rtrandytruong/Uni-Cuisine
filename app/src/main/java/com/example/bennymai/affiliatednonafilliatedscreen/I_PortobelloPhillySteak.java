...
public class I_PortobelloPhillySteak extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__portobello_philly_steak);
        ...
        final DatabaseReference myRef = database.getReference("I_PortobelloPhillySteak_Like");
        final DatabaseReference myRef2 = database.getReference("I_PortobelloPhillySteak_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__portobello_philly_steak);
