...
public class I_ClassicGrilledCheese extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__classic_grilled_cheese);
        ...
        final DatabaseReference myRef = database.getReference("I_ClassicGrilledCheese_Like");
        final DatabaseReference myRef2 = database.getReference("I_ClassicGrilledCheese_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__classic_grilled_cheese);
