...
public class SD_BbqTurkeyCheddarPanini extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd__bbq_turkey_cheddar_panini);
        ...
        final DatabaseReference myRef = database.getReference("SD_BbqTurkeyCheddarPanini_Like");
        final DatabaseReference myRef2 = database.getReference("SD_BbqTurkeyCheddarPanini_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sd__bbq_turkey_cheddar_panini);
