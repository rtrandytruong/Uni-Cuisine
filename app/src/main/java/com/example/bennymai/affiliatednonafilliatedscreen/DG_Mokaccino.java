...
public class DG_Mokaccino extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__mokaccino);
        ...
        final DatabaseReference myRef = database.getReference("DG_Mokaccino_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Mokaccino_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__mokaccino);
