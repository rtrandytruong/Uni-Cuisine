...
public class SD_BroccoliCheddarPanini extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd__broccoli_cheddar_panini);
        ...
        final DatabaseReference myRef = database.getReference("SD_BroccoliCheddarPanini_Like");
        final DatabaseReference myRef2 = database.getReference("SD_BroccoliCheddarPanini_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sd__broccoli_cheddar_panini);
