...
import com.example.bennymai.affiliatednonafilliatedscreen.R;
...
public class Kami_KimichiBulgogiHoagie extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kami__kimichi_bulgogi_hoagie);
        myDialog = new Dialog(this);

        like_button = (ImageButton) findViewById(R.id.like);
        dislike_button = (ImageButton) findViewById(R.id.dislike);

        Kami = (TextView) findViewById(R.id.kamikorean);

        findViewById(R.id.kamikorean).setOnClickListener(this);
        ...
        final DatabaseReference myRef = database.getReference("Kami_KimichiBulgogiHoagie_Like");
        final DatabaseReference myRef2 = database.getReference("Kami_KimichiBulgogiHoagie_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kami__kimichi_bulgogi_hoagie);
    ...
    public void onClick(View v) {
        ...
        if (v==Kami) {
            startActivity(new Intent(this, KamiKorean.class));
        }
