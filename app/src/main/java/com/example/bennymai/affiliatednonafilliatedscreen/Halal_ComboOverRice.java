...
public class Halal_ComboOverRice extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__combo_over_rice);
        ...
        final DatabaseReference myRef = database.getReference("Halal_ComboOverRice_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_ComboOverRice_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__combo_over_rice);
