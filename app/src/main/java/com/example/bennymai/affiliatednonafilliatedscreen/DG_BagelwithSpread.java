...
public class DG_BagelwithSpread extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__bagelwith_spread);
        ...
        final DatabaseReference myRef = database.getReference("DG_BagelwithSpread_Like");
        final DatabaseReference myRef2 = database.getReference("DG_BagelwithSpread_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__bagelwith_spread);
