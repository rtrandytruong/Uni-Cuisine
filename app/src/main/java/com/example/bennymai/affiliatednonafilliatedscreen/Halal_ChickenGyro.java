...
public class Halal_ChickenGyro extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__chicken_gyro);
        ...
        final DatabaseReference myRef = database.getReference("Halal_ChickenGyro_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_ChickenGyro_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__chicken_gyro);
