...
public class ChooseCampus extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         */
        public static ChooseEatery.PlaceholderFragment newInstance(int sectionNumber) {
            ChooseEatery.PlaceholderFragment fragment = new ChooseEatery.PlaceholderFragment();
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    Campus choosecampus = new Campus();
                    return choosecampus;
            }
            return null;
        }
