...
public class DG_Expresso extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__expresso);
        ...
        final DatabaseReference myRef = database.getReference("DG_Expresso_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Expresso_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__expresso);
