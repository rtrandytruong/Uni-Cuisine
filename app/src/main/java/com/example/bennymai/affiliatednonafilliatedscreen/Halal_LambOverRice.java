...
public class Halal_LambOverRice extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("Halal_LambOverRice_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_LambOverRice_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__lamb_over_rice);
