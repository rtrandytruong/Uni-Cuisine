...
public class DG_Latte extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__latte);
        ...
        final DatabaseReference myRef = database.getReference("DG_Latte_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Latte_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__latte);
