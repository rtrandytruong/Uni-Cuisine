...
public class SF_BuildYourOwn extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sf__build_your_own);
        ...
        final DatabaseReference myRef = database.getReference("SF_BuildYourOwn_Like");
        final DatabaseReference myRef2 = database.getReference("SF_BuildYourOwn_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sf__build_your_own);
