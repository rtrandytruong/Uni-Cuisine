...
public class SD_GrilledChickenBaconMelt extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd__grilled_chicken_bacon_melt);
        ...
        final DatabaseReference myRef = database.getReference("SD_GrilledChickenBaconMelt_Like");
        final DatabaseReference myRef2 = database.getReference("SD_GrilledChickenBaconMelt_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sd__grilled_chicken_bacon_melt);
