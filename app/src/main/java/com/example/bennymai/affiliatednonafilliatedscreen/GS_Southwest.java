...
public class GS_Southwest extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gs__southwest);
        ...
        final DatabaseReference myRef = database.getReference("GS_Southwest_Like");
        final DatabaseReference myRef2 = database.getReference("GS_Southwest_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_gs__southwest);
