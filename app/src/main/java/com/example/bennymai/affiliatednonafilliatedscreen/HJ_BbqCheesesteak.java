...
public class HJ_BbqCheesesteak extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hj__bbq_cheesesteak);
        ...
        final DatabaseReference myRef = database.getReference("HJ_BbqCheesesteak_Like");
        final DatabaseReference myRef2 = database.getReference("HJ_BbqCheesesteak_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_hj__bbq_cheesesteak);
