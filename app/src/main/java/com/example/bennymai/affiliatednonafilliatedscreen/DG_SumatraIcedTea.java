...
public class DG_SumatraIcedTea extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__sumatra_iced_tea);
        ...
        final DatabaseReference myRef = database.getReference("DG_SumatraIcedTea_Like");
        final DatabaseReference myRef2 = database.getReference("DG_SumatraIcedTea_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__sumatra_iced_tea);
