...
public class Kim_FriedFishWithGarlicSauce extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kim__fried_fish_with_garlic_sauce);
        myDialog = new Dialog(this);

        like_button = (ImageButton) findViewById(R.id.like);
        dislike_button = (ImageButton) findViewById(R.id.dislike);

        Kim = (TextView) findViewById(R.id.kimfoodtruck);
        ...
        final DatabaseReference myRef = database.getReference("Kim_FriedFishWithGarlicSauce_Like");
        final DatabaseReference myRef2 = database.getReference("Kim_FriedFishWithGarlicSauce_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kim__fried_fish_with_garlic_sauce);
