...
public class V_BuffaloChickenPizza extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v__buffalo_chicken_pizza);
        ...
        final DatabaseReference myRef = database.getReference("V_BuffaloChickenPizza_Like");
        final DatabaseReference myRef2 = database.getReference("V_BuffaloChickenPizza_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_v__buffalo_chicken_pizza);
