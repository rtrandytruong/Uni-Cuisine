...
public class I_CrinkleCutFries extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__crinkle_cut_fries);
        ...
        final DatabaseReference myRef = database.getReference("I_CrinkleCutFries_Like");
        final DatabaseReference myRef2 = database.getReference("I_CrinkleCutFries_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__crinkle_cut_fries);
