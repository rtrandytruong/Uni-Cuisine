...
public class DG_HotTazoTea extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__hot_tazo_tea);
        ...
        final DatabaseReference myRef = database.getReference("DG_HotTazoTea_Like");
        final DatabaseReference myRef2 = database.getReference("DG_HotTazoTea_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__hot_tazo_tea);
