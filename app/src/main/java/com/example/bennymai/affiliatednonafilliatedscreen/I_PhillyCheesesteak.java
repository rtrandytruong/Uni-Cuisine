...
public class I_PhillyCheesesteak extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__philly_cheesesteak);
        ...
        final DatabaseReference myRef = database.getReference("I_PhillyCheesesteak_Like");
        final DatabaseReference myRef2 = database.getReference("I_PhillyCheesesteak_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__philly_cheesesteak);
