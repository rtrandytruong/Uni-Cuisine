...
public class DG_Muffin extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__muffin);
        ...
        final DatabaseReference myRef = database.getReference("DG_Muffin_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Muffin_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__muffin);
