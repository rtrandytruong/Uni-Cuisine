...
public class DG_Brownie extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__brownie);
        ...
        final DatabaseReference myRef = database.getReference("DG_Brownie_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Brownie_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__brownie);
