...
public class Mai_ChickenNoodleSoup extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("Mai_ChickenNoodleSoup_Like");
        final DatabaseReference myRef2 = database.getReference("Mai_ChickenNoodleSoup_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_mai__chicken_noodle_soup);
