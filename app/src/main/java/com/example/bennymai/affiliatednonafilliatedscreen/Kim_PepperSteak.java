...
public class Kim_PepperSteak extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("Kim_PepperSteak_Like");
        final DatabaseReference myRef2 = database.getReference("Kim_PepperSteak_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kim__pepper_steak);
