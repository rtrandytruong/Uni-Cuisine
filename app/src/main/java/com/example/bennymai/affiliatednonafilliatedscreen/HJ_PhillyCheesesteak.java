...
public class HJ_PhillyCheesesteak extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hj__philly_cheesesteak);
        ...
        final DatabaseReference myRef = database.getReference("HJ_PhillyCheesesteak_Like");
        final DatabaseReference myRef2 = database.getReference("HJ_PhillyCheesesteak_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_hj__philly_cheesesteak);
