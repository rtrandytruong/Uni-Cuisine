...
public class HJ_PepperCheesesteak extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hj__pepper_cheesesteak);
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_hj__pepper_cheesesteak);
