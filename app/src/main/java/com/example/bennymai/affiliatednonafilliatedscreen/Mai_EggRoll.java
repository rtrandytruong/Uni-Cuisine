...
public class Mai_EggRoll extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mai__egg_roll);
        ...
        final DatabaseReference myRef = database.getReference("Mai_EggRoll_Like");
        final DatabaseReference myRef2 = database.getReference("Mai_EggRoll_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_mai__egg_roll);
