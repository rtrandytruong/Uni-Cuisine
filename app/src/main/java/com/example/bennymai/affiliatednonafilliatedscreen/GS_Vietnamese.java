...
public class GS_Vietnamese extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gs__vietnamese);
        ...
        final DatabaseReference myRef = database.getReference("GS_Vietnamese_Like");
        final DatabaseReference myRef2 = database.getReference("GS_Vietnamese_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_gs__vietnamese);
