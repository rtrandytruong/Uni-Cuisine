...
public class Kim_FriedDumplings extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kim__fried_dumplings);
        ...
        final DatabaseReference myRef = database.getReference("Kim_FriedDumplings_Like");
        final DatabaseReference myRef2 = database.getReference("Kim_FriedDumplings_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kim__fried_dumplings);
