...
public class Halal_FalafelSalad extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__falafel_salad);
        ...
        final DatabaseReference myRef = database.getReference("Halal_FalafelSalad_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_FalafelSalad_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__falafel_salad);
