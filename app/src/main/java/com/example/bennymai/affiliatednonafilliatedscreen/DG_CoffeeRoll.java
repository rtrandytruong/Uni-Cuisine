...
public class DG_CoffeeRoll extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__coffee_roll);
        ...
        final DatabaseReference myRef = database.getReference("DG_CoffeeRoll_Like");
        final DatabaseReference myRef2 = database.getReference("DG_CoffeeRoll_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__coffee_roll);
