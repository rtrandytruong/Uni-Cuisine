...
public class DG_PoundCake extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__pound_cake);
        ...
        final DatabaseReference myRef = database.getReference("DG_PoundCake_Like");
        final DatabaseReference myRef2 = database.getReference("DG_PoundCake_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__pound_cake);
