...
public class Kim_GeneralTsosChicken extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("Kim_GeneralTsosChicken_Like");
        final DatabaseReference myRef2 = database.getReference("Kim_GeneralTsosChicken_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kim__general_tsos_chicken);
