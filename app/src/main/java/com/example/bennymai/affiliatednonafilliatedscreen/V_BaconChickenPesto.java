...
public class V_BaconChickenPesto extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v__bacon_chicken_pesto);
        ...
        final DatabaseReference myRef = database.getReference("V_BaconChickenPesto_Like");
        final DatabaseReference myRef2 = database.getReference("V_BaconChickenPesto_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_v__bacon_chicken_pesto);
