...
public class Kami_Bibimbap extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kami__bibimbap);
        ...
        final DatabaseReference myRef = database.getReference("Kami_Bibimbap_Like");
        final DatabaseReference myRef2 = database.getReference("Kami_Bibimbap_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kami__bibimbap);
