...
public class Halal_ChickenSalad extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__chicken_salad);
        ...
        final DatabaseReference myRef = database.getReference("Halal_ChickenSalad_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_ChickenSalad_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__chicken_salad);
