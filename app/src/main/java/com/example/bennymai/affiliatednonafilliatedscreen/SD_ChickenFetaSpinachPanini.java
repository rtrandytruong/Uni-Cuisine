...
public class SD_ChickenFetaSpinachPanini extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd__chicken_feta_spinach_panini);
        ...
        final DatabaseReference myRef = database.getReference("SD_ChickenFetaSpinachPanini_Like");
        final DatabaseReference myRef2 = database.getReference("SD_ChickenFetaSpinachPanini_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sd__chicken_feta_spinach_panini);
