...
public class Halal_FalafelRice extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__falafel_rice);
        ...
        final DatabaseReference myRef = database.getReference("Halal_FalafelRice_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_FalafelRice_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__falafel_rice);
