...
public class I_ChickenTenders extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_i__chicken_tenders);
        ...
        final DatabaseReference myRef = database.getReference("I_ChickenTenders_Like");
        final DatabaseReference myRef2 = database.getReference("I_ChickenTenders_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_i__chicken_tenders);
