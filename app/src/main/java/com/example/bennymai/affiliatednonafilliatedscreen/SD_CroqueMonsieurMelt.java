...
public class SD_CroqueMonsieurMelt extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sd__croque_monsieur_melt);
        ...
        final DatabaseReference myRef = database.getReference("SD_CroqueMonsieurMelt_Like");
        final DatabaseReference myRef2 = database.getReference("SD_CroqueMonsieurMelt_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_sd__croque_monsieur_melt);
