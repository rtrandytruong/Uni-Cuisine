...
public class DG_Croissant extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__croissant);
        ...
        final DatabaseReference myRef = database.getReference("DG_Croissant_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Croissant_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__croissant);
