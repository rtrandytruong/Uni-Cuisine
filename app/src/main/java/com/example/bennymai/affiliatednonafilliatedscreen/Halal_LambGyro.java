...
public class Halal_LambGyro extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__lamb_gyro);
        ...
        final DatabaseReference myRef = database.getReference("Halal_LambGyro_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_LambGyro_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__lamb_gyro);
