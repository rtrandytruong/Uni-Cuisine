...
public class Kami_KimchiFriedRiceWrap extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kami__kimchi_fried_rice_wrap);
        ...
        final DatabaseReference myRef = database.getReference("Kami_KimchiFriedRiceWrap_Like");
        final DatabaseReference myRef2 = database.getReference("Kami_KimchiFriedRiceWrap_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kami__kimchi_fried_rice_wrap);
