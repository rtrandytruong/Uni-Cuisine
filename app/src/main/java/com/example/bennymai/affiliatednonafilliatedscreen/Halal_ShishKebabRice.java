...
public class Halal_ShishKebabRice extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__shish_kebab_rice);
        ...
        final DatabaseReference myRef = database.getReference("Halal_ShishKebabRice_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_ShishKebabRice_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__shish_kebab_rice);
