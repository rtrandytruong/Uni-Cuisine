...
public class DG_Scone extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__scone);
        ...
        final DatabaseReference myRef = database.getReference("DG_Scone_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Scone_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__scone);
