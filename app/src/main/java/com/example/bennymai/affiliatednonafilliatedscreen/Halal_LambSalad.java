...
public class Halal_LambSalad extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halal__lamb_salad);
        ...
        final DatabaseReference myRef = database.getReference("Halal_LambSalad_Like");
        final DatabaseReference myRef2 = database.getReference("Halal_LambSalad_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_halal__lamb_salad);
