...
public class V_CaesarSideSalad extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_v__caesar_side_salad);
        ...
        final DatabaseReference myRef = database.getReference("V_CaesarSideSalad_Like");
        final DatabaseReference myRef2 = database.getReference("V_CaesarSideSalad_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_v__caesar_side_salad);
