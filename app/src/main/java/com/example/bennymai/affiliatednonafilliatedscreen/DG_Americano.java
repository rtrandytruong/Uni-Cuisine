...
public class DG_Americano extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__americano);
        ...
        final DatabaseReference myRef = database.getReference("DG_Americano_Like");
        final DatabaseReference myRef2 = database.getReference("DG_Americano_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__americano);
