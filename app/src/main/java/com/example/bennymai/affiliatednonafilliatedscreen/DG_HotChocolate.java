...
public class DG_HotChocolate extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dg__hot_chocolate);
        ...
        final DatabaseReference myRef = database.getReference("DG_HotChocolate_Like");
        final DatabaseReference myRef2 = database.getReference("DG_HotChocolate_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_dg__hot_chocolate);
