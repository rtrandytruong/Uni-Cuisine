...
public class Mai_WontonSoup extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mai__wonton_soup);
        ...
        final DatabaseReference myRef = database.getReference("Mai_WontonSoup_Like");
        final DatabaseReference myRef2 = database.getReference("Mai_WontonSoup_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_mai__wonton_soup);
