...
public class Kami_Tteokbokki extends AppCompatActivity implements View.OnClickListener {
    Dialog myDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kami__tteokbokki);
        ...
        final DatabaseReference myRef = database.getReference("Kami_Tteokbokki_Like");
        final DatabaseReference myRef2 = database.getReference("Kami_Tteokbokki_Dislike");
    ...
    public void ShowPopup(View v) {
        myDialog.setContentView(R.layout.activity_kami__tteokbokki);
